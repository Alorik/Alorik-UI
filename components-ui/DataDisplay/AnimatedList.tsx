        ...
        <AnimatePresence mode="popLayout">
          {items.map((item) => (
            <motion.div
              ...
              className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex justify-between items-center group bg-linear-to-r from-cyan-500/0 via-cyan-500/10 to-cyan-500/0 opacity-0 group-hover:opacity-100 transition-opacity bg-size-[200%_auto] animate-[beam-slide_2s_linear_infinite]"
            >
              <div
