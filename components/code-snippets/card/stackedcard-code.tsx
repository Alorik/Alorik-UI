  ...
  return (
    <div className="flex items-center justify-center h-[500px] bg-slate-100">
      ...
      >
        ...
        <motion.div
          className="absolute inset-0 rounded-2xl bg-gradient-to-br from-rose-500 to-rose-600 shadow-xl border border-rose-400/50 flex flex-col justify-between p-5 text-white z-0"
          variants={{
...
export default function StackedCardCode() {
  return (
    <>
      <CodeShowCase language=".tsx" code={code} title="Stacked Card" />
    </>
  );
}
