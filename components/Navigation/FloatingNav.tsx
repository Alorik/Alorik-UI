...
return (
  <div className="fixed top-6 left-1/2 -translate-x-1/2">
    <div className="flex gap-2 px-4 py-2 bg-slate-900 rounded-full">
      <div className="flex items-center gap-2 px-2 py-2 rounded-full border border-white/10 bg-slate-900/60 backdrop-blur-xl shadow-2xl shadow-black/50">
        <motion.nav
          variants={{
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  style={{
                    color: isActive ? "#fff" : "#94a3b8", // White vs Slate-400
                  }}
                >
                  {isActive && (
                    <motion.div
